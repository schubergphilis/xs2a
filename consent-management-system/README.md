...
```
We use liquibase for generating DB tables. Property file with settings you can find in resources folder. You can find guide how to work with liquibase in the `cms-db-schema/README.md` file.
