...
public class ConsentTestData {
    ...
    private void fillConsents() {
        aisConsentRepository.save(getConsent("cucumber-c54a-3322-5555-939f26c20001", ConsentStatus.RECEIVED, 100,10, LocalDate.parse("2018-11-10"), "d9e71419-24e4-4c5a-8d93-fcc23153aaff", "tpp01", false, getAccounts("DE52500105173911841934")));
        aisConsentRepository.save(getConsent("cucumber-c54a-3322-5555-939f26c20002", ConsentStatus.VALID, 100,1, LocalDate.parse("2018-10-10"), "d9e71419-24e4-4c5a-8d93-fcc23153aaff", "tpp01", false, getAccounts("DE28500105174342597929")));
        aisConsentRepository.save(getConsent("cucumber-c54a-3322-5555-939f26c20003", ConsentStatus.REJECTED, 100,10, LocalDate.parse("2018-11-10"), "d9e71419-24e4-4c5a-8d93-fcc23153aaff", "tpp01", false, getAccounts("DE75500105172377958695")));
        aisConsentRepository.save(getConsent("cucumber-c54a-3322-5555-939f26c20004", ConsentStatus.REVOKED_BY_PSU, 100,10, LocalDate.parse("2018-09-16"), "d9e71419-24e4-4c5a-8d93-fcc23153aaff", "tpp01", false, getAccounts("DE50500105177788564243")));
        aisConsentRepository.save(getConsent("cucumber-c54a-3322-5555-939f26c20005", ConsentStatus.TERMINATED_BY_TPP, 100,10, LocalDate.parse("2018-11-10"), "d9e71419-24e4-4c5a-8d93-fcc23153aaff", "tpp01", false, getAccounts("DE55500105177514478625")));
        aisConsentRepository.save(getConsent("cucumber-c54a-3322-5555-939f26c20006", ConsentStatus.EXPIRED, 100,10, LocalDate.parse("2017-11-10"), "d9e71419-24e4-4c5a-8d93-fcc23153aaff", "tpp01", false, getAccounts("DE48500105172747665854")));
    }
