...
public class ConsentInformationControllerTest {
    ...
    public void setUp() {
        ...
        when(consentService.getAccountConsentsStatusById(WRONG_CONSENT_ID)).thenReturn(ResponseObject.<ConsentStatus>builder().fail(new MessageError(Collections.singletonList(new TppMessageInformation(MessageCategory.ERROR, MessageErrorCode.RESOURCE_UNKNOWN_404)))).build());
        ...
        when(consentService.deleteAccountConsentsById(WRONG_CONSENT_ID)).thenReturn(ResponseObject.<Void>builder().fail(new MessageError(Collections.singletonList(new TppMessageInformation(MessageCategory.ERROR, MessageErrorCode.RESOURCE_UNKNOWN_404)))).build());
    }
    ...
    private ResponseObject createConsentResponse(String consentId) {
        return isEmpty(consentId)
                   ? ResponseObject.builder().fail(new MessageError(Collections.singletonList(new TppMessageInformation(MessageCategory.ERROR, MessageErrorCode.RESOURCE_UNKNOWN_404)))).build()
