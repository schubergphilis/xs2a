...
public class AccountMapperTest {
    ...
    public void mapSpiAccountDetailsToXs2aAccountDetails() throws IOException {
        ...
        assertThat(closingBooked.getLastActionDateTime()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(closingBooked.getDate()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
    }
    ...
    public void mapSpiBalances() throws IOException {
        ...
        assertThat(actualBalances.get(0).getClosingBooked().getLastActionDateTime()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getClosingBooked().getDate()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getAuthorised().getAmount().getCurrency().getCurrencyCode()).isEqualTo("EUR");
        assertThat(actualBalances.get(0).getAuthorised().getLastActionDateTime()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getAuthorised().getDate()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getExpected().getAmount().getCurrency().getCurrencyCode()).isEqualTo("EUR");
        assertThat(actualBalances.get(0).getExpected().getLastActionDateTime()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getExpected().getDate()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getInterimAvailable().getAmount().getCurrency().getCurrencyCode()).isEqualTo("EUR");
        assertThat(actualBalances.get(0).getInterimAvailable().getLastActionDateTime()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getInterimAvailable().getDate()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getOpeningBooked().getAmount().getCurrency().getCurrencyCode()).isEqualTo("EUR");
        assertThat(actualBalances.get(0).getOpeningBooked().getLastActionDateTime()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
        assertThat(actualBalances.get(0).getOpeningBooked().getDate()).isEqualTo(Instant.parse("2019-12-03T00:00:00.00Z"));
    }
