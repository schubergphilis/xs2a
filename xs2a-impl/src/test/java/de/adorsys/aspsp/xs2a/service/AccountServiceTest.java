...
public class AccountServiceTest {
    ...
    public void getAccountDetailsByAccountId_Failure_wrongAccount() {
        ...
        assertThat(response.getError().getResponseTppMessage().getMessageErrorCode()).isEqualTo(RESOURCE_UNKNOWN_404);
    }
    ...
    public void getAccountDetailsByAccountId_Failure_wrongConsent() {
        ...
        assertThat(response.hasError()).isEqualTo(true);
        assertThat(response.getError().getTransactionStatus()).isEqualTo(TransactionStatus.RJCT);
        assertThat(response.getError().getResponseTppMessage().getMessageErrorCode()).isEqualTo(CONSENT_UNKNOWN_403);
    }
    ...
    public void getBalances_Failure_Consent_WOB() {
        ...
        assertThat(response.hasError()).isEqualTo(true);
        assertThat(response.getError().getTransactionStatus()).isEqualTo(TransactionStatus.RJCT);
        assertThat(response.getError().getResponseTppMessage().getMessageErrorCode()).isEqualTo(CONSENT_INVALID);
    }
