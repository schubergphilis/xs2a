...
@RestController
@AllArgsConstructor
@RequestMapping(path = "funds-confirmations")
@Api(value = "funds-confirmations", tags = "PIISP, Funds confirmation", description = "Provides access to the funds confirmation")
