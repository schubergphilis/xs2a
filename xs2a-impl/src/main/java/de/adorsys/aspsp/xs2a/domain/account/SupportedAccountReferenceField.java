...
public enum SupportedAccountReferenceField {
    IBAN {
        @Override
        public Optional<Boolean> isValid(de.adorsys.psd2.custom.AccountReference reference) {
    ...
    public abstract Optional<Boolean> isValid(de.adorsys.psd2.custom.AccountReference reference);
