...
public enum ConsentAuthorisationResponseLinkType {
    ...
    private static final Map<String, ConsentAuthorisationResponseLinkType> container = new HashMap<>();

    private String value;

    ConsentAuthorisationResponseLinkType(String value) {
        this.value = value;
    }

    static {
        for (ConsentAuthorisationResponseLinkType type : values()) {
    ...
    public static Optional<ConsentAuthorisationResponseLinkType> getByValue(String value) {
