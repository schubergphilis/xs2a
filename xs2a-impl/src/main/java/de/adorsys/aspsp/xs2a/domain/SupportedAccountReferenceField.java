...
public enum SupportedAccountReferenceField {
    ...
    IBAN {
        @Override
        public Optional<Boolean> isValid(Object reference) {
    ...
    BBAN {
        ...
        public Optional<Boolean> isValid(Object reference) {
            return Optional.ofNullable(reference)
                .filter(o -> o instanceof AccountReferenceBban)
                .map(o -> (AccountReferenceBban) o)
                .map(o -> o.getBban())
    ...
    PAN {
        ...
        public Optional<Boolean> isValid(Object reference) {
            return Optional.ofNullable(reference)
                .filter(o -> o instanceof AccountReferencePan)
                .map(o -> (AccountReferencePan) o)
                .map(o -> o.getPan())
    ...
    MASKEDPAN {
        ...
        public Optional<Boolean> isValid(Object reference) {
            return Optional.ofNullable(reference)
                .filter(o -> o instanceof AccountReferenceMaskedPan)
                .map(o -> (AccountReferenceMaskedPan) o)
                .map(o -> o.getMaskedPan())
    ...
    MSISDN {
        ...
        public Optional<Boolean> isValid(Object reference) {
            return Optional.ofNullable(reference)
                .filter(o -> o instanceof AccountReferenceMsisdn)
                .map(o -> (AccountReferenceMsisdn) o)
                .map(o -> o.getMsisdn())
                .map(SupportedAccountReferenceField::isValidMsisdn);
        }
    };

    public abstract Optional<Boolean> isValid(Object reference);
