...
public class ReadSinglePayment extends ReadPayment<SinglePayment> {
    ...
    public SinglePayment getPayment(String paymentId, String paymentProduct) {
        SpiResponse<SpiSinglePayment> spiResponse = paymentSpi.getSinglePaymentById(paymentMapper.mapToSpiPaymentType(SINGLE), paymentProduct, paymentId, pisConsentDataService.getAspspConsentData(paymentId));
