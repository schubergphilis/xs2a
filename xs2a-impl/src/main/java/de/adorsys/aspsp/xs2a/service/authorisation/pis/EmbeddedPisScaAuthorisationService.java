...
public class EmbeddedPisScaAuthorisationService implements PisScaAuthorisationService {
    ...
    /**
     * Creates authorisation for pis consent
     *
     * @param paymentId   ASPSP identifier of a payment
     * @param paymentType Type of payment
     * @return create consent authorisation response, which contains authorisation id, sca status, payment type and links
     */
    @Override
    public Optional<Xsa2CreatePisConsentAuthorisationResponse> createConsentAuthorisation(String paymentId, PaymentType paymentType) {
        return pisConsentMapper.mapToXsa2CreatePisConsentAuthorisationResponse(authorisationService.createPisConsentAuthorisation(paymentId), paymentType);
    }

    /**
     * Updates authorisation for pis consent
     *
