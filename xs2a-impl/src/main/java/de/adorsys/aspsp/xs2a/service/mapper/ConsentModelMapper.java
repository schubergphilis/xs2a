...
public class ConsentModelMapper {
    ...
    public StartScaprocessResponse mapToStartScaProcessResponse(CreateConsentAuthorisationResponse createConsentAuthorisationResponse) {
        return Optional.ofNullable(createConsentAuthorisationResponse)
                   .map(csar -> {
                       ControllerLinkBuilder link = linkTo(methodOn(ConsentApi.class)._updateConsentsPsuData(csar.getConsentId(), csar.getAuthorisationId(), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));

                       return new StartScaprocessResponse()
                                  .scaStatus(createConsentAuthorisationResponse.getScaStatus())
    ...
    public UpdateConsentPsuDataReq mapToUpdatePsuData(String psuId, String consentId, String authorisationId, Map body) {
        ...
        updatePsuData.setAuthorisationId(authorisationId);
