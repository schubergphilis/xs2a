...
public class ConsentModelMapper {
    ...
    public static UpdatePsuAuthenticationResponse mapToUpdatePsuAuthenticationResponse(UpdateAisConsentPsuDataResponse response) {
    ...
    public static UpdateAisConsentPsuDataRequest mapToAisUpdatePsuData(String psuId, String consentId, String authorizationId, Map body) {
        UpdateAisConsentPsuDataRequest updatePsuData = new UpdateAisConsentPsuDataRequest();
