...
public class ReadBulkPayment extends ReadPayment<BulkPayment> {
    ...
    public BulkPayment getPayment(String paymentId, String paymentProduct) {
        SpiResponse<List<SpiSinglePayment>> spiResponse = paymentSpi.getBulkPaymentById(paymentMapper.mapToSpiPaymentType(BULK), paymentProduct, paymentId, pisConsentDataService.getAspspConsentData(paymentId));
