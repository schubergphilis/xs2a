...
public class AspspProfileServiceTest {
    ...
    private static final AuthorisationStartType AUTHORISATION_START_TYPE = AuthorisationStartType.IMPLICIT;
    ...
    public void setUpAccountServiceMock() {
        ...
        Mockito.when(profileConfiguration.getAuthorisationStartType())
            .thenReturn(AUTHORISATION_START_TYPE);
        ...
        Mockito.when(profileConfiguration.isPaymentCancellationAuthorisationMandated())
            .thenReturn(PAYMENT_CANCELLATION_AUTHORISATION_MANDATED);
