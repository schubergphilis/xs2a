...
public class TppMessageAISACCESSEXCEEDED429 {
    ...
    public TppMessageAISACCESSEXCEEDED429 category(TppMessageCategory category) {
    ...
    public TppMessageAISACCESSEXCEEDED429 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessageAISACCESSEXCEEDED429 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessageAISACCESSEXCEEDED429 text(String text) {
        this.text = text;
        return this;
    }
