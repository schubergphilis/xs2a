 ...
 */
@ApiModel(description = "Messages with HTTP error code 401 to the TPP on operational issues.")
@Validated
...
public class TppMessages401 extends ArrayList<Object> {
    ...
    public String toString() {
        ...
        sb.append("class TppMessages401 {\n");
