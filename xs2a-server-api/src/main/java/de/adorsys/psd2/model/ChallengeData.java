...
/**
 * It is contained in addition to the data element &#x27;chosenScaMethod&#x27; if challenge data is needed for SCA. In rare cases this
 * attribute is also used in the context of the &#x27;startAuthorisationWithPsuAuthentication&#x27; link.
 */
...
public class ChallengeData {
    ...
    /**
     * PNG data (max. 512 kilobyte) to be displayed to the PSU, Base64 encoding, cp. [RFC4648]. This attribute is used only, when PHOTO_OTP
    ...
    /**
     * Additional explanation for the PSU to explain e.g. fallback mechanism for the chosen SCA method. The TPP is obliged to show this to
     * the PSU.
     *
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.image, challengeData.image) && Objects.equals(this.data, challengeData.data)
            && Objects.equals(this.imageLink, challengeData.imageLink) && Objects.equals(this.otpMaxLength, challengeData.otpMaxLength)
