 ...
 */
@ApiModel(description = "Messages with HTTP error code 406 to the TPP on operational issues.")
@Validated
...
public class TppMessages406 extends ArrayList<Object> {
    ...
    public String toString() {
        ...
        sb.append("class TppMessages406 {\n");
