 ...
 */
@ApiModel(description = "Messages with HTTP error code 429 to the TPP on operational issues.")
@Validated
...
public class TppMessages429 extends ArrayList<Object> {
    ...
    public String toString() {
        ...
        sb.append("class TppMessages429 {\n");
