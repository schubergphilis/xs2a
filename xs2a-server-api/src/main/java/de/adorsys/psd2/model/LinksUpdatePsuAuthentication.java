...
/**
 * A list of hyperlinks to be recognised by the TPP. Might be contained, if several authentication methods are available for the PSU. Type
 * of links admitted in this response: * &#x27;selectAuthenticationMethod&#x27;: This is a link to a resource, where the TPP can select the
 * applicable second factor authentication methods for the PSU, if there were several available authentication methods. This link is only
 * contained, if the PSU is already identified or authenticated with the first relevant factor or alternatively an access token, if SCA is
 * required and if the PSU has a choice between different authentication methods. If this link is contained, then there is also the data
 * element &#x27;scaMethods&#x27; contained in the response body. * &#x27;authoriseTransaction&#x27;: The link to the resource, where the
 * \&quot;Transaction Authorisation Request\&quot; is sent to. This is the link to the resource which will authorise the transaction by
 * checking the SCA authentication data within the Embedded SCA approach. * &#x27;scaStatus&#x27;: The link to retrieve the scaStatus of the
...
public class LinksUpdatePsuAuthentication extends HashMap<String, String> {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.selectAuthenticationMethod, _linksUpdatePsuAuthentication.selectAuthenticationMethod)
            ...
            && Objects.equals(this.scaStatus, _linksUpdatePsuAuthentication.scaStatus) && super.equals(o);
    }
