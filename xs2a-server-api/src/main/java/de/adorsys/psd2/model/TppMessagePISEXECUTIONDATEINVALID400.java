...
public class TppMessagePISEXECUTIONDATEINVALID400 {
    ...
    public TppMessagePISEXECUTIONDATEINVALID400 category(TppMessageCategory category) {
    ...
    public TppMessagePISEXECUTIONDATEINVALID400 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessagePISEXECUTIONDATEINVALID400 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessagePISEXECUTIONDATEINVALID400 text(String text) {
        this.text = text;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class TppMessagePISEXECUTIONDATEINVALID400 {\n");
    ...
    public enum CodeEnum {
        INVALID("EXECUTION_DATE_INVALID");
