...
public class TppMessageGENERICPERIODINVALID400 {
    ...
    public TppMessageGENERICPERIODINVALID400 category(TppMessageCategory category) {
    ...
    public TppMessageGENERICPERIODINVALID400 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessageGENERICPERIODINVALID400 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessageGENERICPERIODINVALID400 text(String text) {
        this.text = text;
        return this;
    }
