...
/**
 * This parameter is requesting a valid until date for the requested consent. The content is the local ASPSP date in ISO-Date Format, e.g.
 * 2017-10-30. If a maximal available date is requested, a date in far future is to be used: \&quot;9999-12-31\&quot;. The consent object to
 * be retrieved by the GET Consent Request will contain the adjusted date.
 */
