...
public class TppMessageGENERICRESOURCEEXPIRED403400 {
    ...
    public TppMessageGENERICRESOURCEEXPIRED403400 category(TppMessageCategory category) {
    ...
    public TppMessageGENERICRESOURCEEXPIRED403400 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessageGENERICRESOURCEEXPIRED403400 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessageGENERICRESOURCEEXPIRED403400 text(String text) {
        this.text = text;
        return this;
    }
