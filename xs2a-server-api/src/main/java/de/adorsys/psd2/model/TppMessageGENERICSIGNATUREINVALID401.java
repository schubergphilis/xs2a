...
public class TppMessageGENERICSIGNATUREINVALID401 {
    ...
    public TppMessageGENERICSIGNATUREINVALID401 category(TppMessageCategory category) {
    ...
    public TppMessageGENERICSIGNATUREINVALID401 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessageGENERICSIGNATUREINVALID401 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessageGENERICSIGNATUREINVALID401 text(String text) {
        this.text = text;
        return this;
    }
