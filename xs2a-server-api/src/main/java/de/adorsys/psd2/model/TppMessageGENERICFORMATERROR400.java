...
/**
 * Format of certain request fields are not matching the XS2A requirements. An explicit path to the corresponding field might be added in
 * the return message.
 */
...
public class TppMessageGENERICFORMATERROR400 {
    ...
    public TppMessageGENERICFORMATERROR400 category(TppMessageCategory category) {
    ...
    public TppMessageGENERICFORMATERROR400 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessageGENERICFORMATERROR400 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessageGENERICFORMATERROR400 text(String text) {
        this.text = text;
        return this;
    }
