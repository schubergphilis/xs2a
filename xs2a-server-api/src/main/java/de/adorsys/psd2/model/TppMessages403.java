 ...
 */
@ApiModel(description = "Messages with HTTP error code 403 to the TPP on operational issues.")
@Validated
...
public class TppMessages403 extends ArrayList<Object> {
    ...
    public String toString() {
        ...
        sb.append("class TppMessages403 {\n");
