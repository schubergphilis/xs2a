...
/**
 * The addressed resource is unknown relative to the TPP. - 404 (if account-id in path) - 403 (if other resource in path) - 400 (if payload)
 */
...
public class TppMessageGENERICRESOURCEUNKNOWN404403400 {
    ...
    public TppMessageGENERICRESOURCEUNKNOWN404403400 category(TppMessageCategory category) {
    ...
    public TppMessageGENERICRESOURCEUNKNOWN404403400 code(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public TppMessageGENERICRESOURCEUNKNOWN404403400 path(String path) {
        this.path = path;
        return this;
    }
    ...
    public TppMessageGENERICRESOURCEUNKNOWN404403400 text(String text) {
        this.text = text;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class TppMessageGENERICRESOURCEUNKNOWN404403400 {\n");
