...
/**
 * JSON response body consistion of the corresponding bulk SCT payment initation JSON body together with an optional transaction status
 * field.
 */
...
public class BulkPaymentInitiationSctWithStatusResponse {
    ...
    @Valid
    private List<PaymentInitiationSctJson> payments = new ArrayList<PaymentInitiationSctJson>();
