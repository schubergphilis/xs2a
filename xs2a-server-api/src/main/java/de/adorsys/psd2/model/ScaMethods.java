...
/**
 * This data element might be contained, if SCA is required and if the PSU has a choice between different authentication methods. Depending
 * on the risk management of the ASPSP this choice might be offered before or after the PSU has been identified with the first relevant
 * factor, or if an access token is transported. If this data element is contained, then there is also an hyperlink of type
 * &#x27;startAuthorisationWithAuthenticationMethodSelection&#x27; contained in the response body. These methods shall be presented towards
