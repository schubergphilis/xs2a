...
/**
 * JSON response body consistion of the corresponding TARGET-2 payment initation JSON body together with an optional transaction status
 * field.
 */
...
public class PaymentInitiationTarget2WithStatusResponse {
    ...
    public PaymentInitiationTarget2WithStatusResponse debtorAccount(Object debtorAccount) {
    ...
    public PaymentInitiationTarget2WithStatusResponse creditorAccount(Object creditorAccount) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.endToEndIdentification, paymentInitiationTarget2WithStatusResponse.endToEndIdentification)
            ...
            paymentInitiationTarget2WithStatusResponse.remittanceInformationUnstructured)
    ...
    public int hashCode() {
        return Objects.hash(endToEndIdentification, debtorAccount, instructedAmount, creditorAccount, creditorAgent, creditorName,
            creditorAddress, remittanceInformationUnstructured, transactionStatus);
    }
