 ...
 */
@ApiModel(description = "Messages with HTTP error code 404 to the TPP on operational issues.")
@Validated
...
public class TppMessages404 extends ArrayList<Object> {
    ...
    public String toString() {
        ...
        sb.append("class TppMessages404 {\n");
