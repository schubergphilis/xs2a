 ...
 * configuration follows the OAuth 2.0 Authorisation Server Metadata specification. - &#x27;updatePsuIdentification&#x27;: The link to the
 * authorisation or cancellation authorisation sub-resource, where PSU identification data needs to be uploaded. -
 * &#x27;startAuthorisationWithPsuAuthentication&#x27;: The link to the authorisation or cancellation authorisation sub-resource, where PSU
 * authentication data needs to be uploaded. - &#x27;selectAuthenticationMethod&#x27;: The link to the authorisation or cancellation
 * authorisation sub-resource, where the selected authentication method needs to be uploaded. This link is contained under exactly the same
 * conditions as the data element &#x27;scaMethods&#x27;. - &#x27;authoriseTransaction&#x27;: The link to the authorisation or cancellation
 * authorisation sub-resource, where the authorisation data has to be uploaded, e.g. the TOP received by SMS. - &#x27;scaStatus&#x27;: The
 * link to retrieve the scaStatus of the corresponding authorisation sub-resource.
 */
...
public class LinksStartScaProcess extends HashMap<String, String> {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.scaRedirect, _linksStartScaProcess.scaRedirect)
            ...
            _linksStartScaProcess.startAuthorisationWithPsuAuthentication)
            ...
            && Objects.equals(this.scaStatus, _linksStartScaProcess.scaStatus) && super.equals(o);
    }

    @Override
    public int hashCode() {
        return Objects.hash(scaRedirect, scaOAuth, updatePsuIdentification, startAuthorisationWithPsuAuthentication,
            selectAuthenticationMethod, authoriseTransaction, scaStatus, super.hashCode());
    }
