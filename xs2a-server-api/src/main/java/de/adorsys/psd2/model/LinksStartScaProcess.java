...
/**
 * A list of hyperlinks to be recognised by the TPP. The actual hyperlinks used in the  response depend on the dynamical decisions of the ASPSP when processing the request.  **Remark:** All links can be relative or full links, to be decided by the ASPSP.  Type of links admitted in this response, (further links might be added for ASPSP defined  extensions):  - &#x27;scaRedirect&#x27;:    In case of an SCA Redirect Approach, the ASPSP is transmitting the link to which to    redirect the PSU browser. - &#x27;scaOAuth&#x27;:    In case of a SCA OAuth2 Approach, the ASPSP is transmitting the URI where the configuration of the Authorisation Server can be retrieved. The configuration follows the OAuth 2.0 Authorisation Server Metadata specification. - &#x27;updatePsuIdentification&#x27;:    The link to the authorization or cancellation authorization sub-resource,    where PSU identification data needs to be uploaded. - &#x27;startAuthorizationWithPsuAuthentication&#x27;:   The link to the authorization or cancellation authorization sub-resource,    where PSU authentication data needs to be uploaded. - &#x27;selectAuthenticationMethod&#x27;:   The link to the authorization or cancellation authorization sub-resource,    where the selected authentication method needs to be uploaded.    This link is contained under exactly the same conditions as the data element &#x27;scaMethods&#x27;. - &#x27;authoriseTransaction&#x27;:   The link to the authorization or cancellation authorization sub-resource,    where the authorization data has to be uploaded, e.g. the TOP received by SMS.  - &#x27;scaStatus&#x27;:    The link to retrieve the scaStatus of the corresponding authorization sub-resource.
 */
