 ...
 * admitted in this response, (further links might be added for ASPSP defined extensions): * &#x27;scaRedirect&#x27;: In case of an SCA
 * Redirect Approach, the ASPSP is transmitting the link to which to redirect the PSU browser. * &#x27;scaOAuth&#x27;: In case of a SCA
 * OAuth2 Approach, the ASPSP is transmitting the URI where the configuration of the Authorisation Server can be retrieved. The
 * configuration follows the OAuth 2.0 Authorisation Server Metadata specification. * &#x27;startAuthorisation&#x27;: In case, where an
 * explicit start of the transaction authorisation is needed, but no more data needs to be updated (no authentication method to be selected,
 * no PSU identification nor PSU authentication data to be uploaded). * &#x27;startAuthorisationWithPsuIdentification&#x27;: The link to the
...
public class LinksPaymentInitiation extends HashMap<String, String> {
    ...
    public LinksPaymentInitiation startAuthorisationWithAuthenticationMethodSelection(
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.scaRedirect, _linksPaymentInitiation.scaRedirect)
            ...
            _linksPaymentInitiation.startAuthorisationWithPsuIdentification)
            && Objects.equals(this.startAuthorisationWithPsuAuthentication,
            _linksPaymentInitiation.startAuthorisationWithPsuAuthentication)
            ...
            _linksPaymentInitiation.startAuthorisationWithTransactionAuthorisation)
            && Objects.equals(this.self, _linksPaymentInitiation.self) && Objects.equals(this.status, _linksPaymentInitiation.status)
            && Objects.equals(this.scaStatus, _linksPaymentInitiation.scaStatus) && super.equals(o);
    }
