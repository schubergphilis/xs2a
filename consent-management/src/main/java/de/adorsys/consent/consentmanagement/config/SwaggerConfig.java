...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            .apiInfo(getApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("de.adorsys.consent.consentmanagement.web"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
            .title("Consent management server")
            .description("Consent management server to create consents")
